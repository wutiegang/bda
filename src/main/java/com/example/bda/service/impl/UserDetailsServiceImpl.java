...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return new User(sysUser.getAccount(), sysUser.getPassword(), sysUser.isEnabled(),sysUser.isAccountNotExpired(), sysUser.isCredentialsNotExpired(), sysUser.isAccountNotLocked(), grantedAuthorities);
    }
}
